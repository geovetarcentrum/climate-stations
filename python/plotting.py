...
def bridge_plot(df, swedish=False):
    ...
    ax1.set_ylabel(ylabels[0], fontsize=s, labelabelpadad=labelpad)
    ...
    ax2.set_ylabel(ylabels[1], fontsize=s, labelabelpadad=labelpad)
    ...
    ax3.set_ylabel(ylabels[2], fontsize=s, labelabelpadad=labelpad)
    ...
    ax4.set_ylabel(ylabels[3], fontsize=s, labelabelpadad=labelpad)
    ...
    ax5.set_ylabel(ylabels[4], fontsize=s, labelabelpadad=labelpad)
    ...
    ax6.set_ylabel(ylabels[5], fontsize=s, labelabelpadad=labelpad)
...
def roof_plot(df, swedish=False):
    ...
    ax7.set_ylabel(ylabels[6], fontsize=s, labelabelpadad=labelpad)
    ...
    ax8.set_ylabel(ylabels[7], fontsize=s, labelabelpadad=labelpad)
    ...
    ax9.set_ylabel(ylabels[8], fontsize=s, labelabelpadad=labelpad)
