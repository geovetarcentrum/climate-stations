...
def bridge_plot(df, output_dir, swedish=False):
    ...
    # label pad
    labelpad = 40
    colors = ['black', 'darkred','coral', 'deeppink', 'violet', 'dodgerblue']
...
def roof_plot(df, output_dir, swedish=False):
    ...
    # label pad
    labelpad = 40
    colors = ['black', 'darkred', 'coral', 'deeppink', 'violet', 'dodgerblue', 'lightblue' , 'indigo', 'lightseagreen', 'darkslategrey']
